...
register(id="vbarc-auto-lab-v0", entry_point="gym_donkeycar.envs.donkey_env:VbarcAutoLabEnv")

register(id="vbarc-open-day-v0", entry_point="gym_donkeycar.envs.donkey_env:VbarcOpenDayEnv")
